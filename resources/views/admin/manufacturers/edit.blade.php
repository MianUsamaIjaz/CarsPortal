    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.manufacturers.update", [$manufacturer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manufacturer') ? 'is-invalid' : '' }}" type="text" name="manufacturer" id="manufacturer" value="{{ old('manufacturer', $manufacturer->manufacturer) }}" required>
