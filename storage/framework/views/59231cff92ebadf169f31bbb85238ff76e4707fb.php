...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.create')); ?> <?php echo e(trans('cruds.franchise.title_singular')); ?>

    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.franchises.store")); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('short_code') ? 'is-invalid' : ''); ?>" type="text" name="short_code" id="short_code" value="<?php echo e(old('short_code', '')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cars\resources\views/admin/franchises/create.blade.php ENDPATH**/ ?>