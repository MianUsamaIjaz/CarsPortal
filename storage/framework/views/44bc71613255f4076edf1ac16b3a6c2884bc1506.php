<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('car_access')): ?>
                    <li class="nav-item">
                ...
                <?php endif; ?>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route("admin.franchises.index")); ?>" class="nav-link <?php echo e(request()->is("admin/franchises") || request()->is("admin/franchises/*") ? "active" : ""); ?>">
                            <i class="fa-fw nav-icon fas fa-taxi">

                            </i>
                            <p>
                                <?php echo e(trans('cruds.franchise.title')); ?>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route("admin.manufacturers.index")); ?>" class="nav-link <?php echo e(request()->is("admin/manufacturers") || request()->is("admin/manufacturers/*") ? "active" : ""); ?>">
                            <i class="fa-fw nav-icon fas fa-taxi">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route("admin.carModels.index")); ?>" class="nav-link <?php echo e(request()->is("admin/carModels") || request()->is("admin/carModels/*") ? "active" : ""); ?>">
                            <i class="fa-fw nav-icon fas fa-taxi">

                            </i>
                            <p>
                                <?php echo e(trans('cruds.carModel.title')); ?>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp\htdocs\Cars\resources\views/partials/menu.blade.php ENDPATH**/ ?>