    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.cars.update", [$car->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('carModel') ? 'is-invalid' : ''); ?>" type="text" name="carModel" id="carModel" value="<?php echo e(old('carModel', $car->carModel)); ?>" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('locations') ? 'is-invalid' : ''); ?>" name="locations[]" id="locations" multiple>
                    <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((in_array($id, old('locations', [])) || $car->locations->contains($id)) ? 'selected' : ''); ?>><?php echo e($location); ?></option>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('color') ? 'is-invalid' : ''); ?>" name="color_id" id="color_id" required>
                    <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((old('color_id') ? old('color_id') : $car->color->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cars\resources\views/admin/cars/edit.blade.php ENDPATH**/ ?>